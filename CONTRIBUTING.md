...
This repository is a **fork**: upstream [iotexproject/iotex-core](https://github.com/iotexproject/iotex-core)
...
a general-purpose fork of iotexproject/iotex-core.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v2.4.2-ct.3`); a GitHub Release publishes the versioned images
